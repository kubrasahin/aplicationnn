  ...
  updateProducttt() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      Map<String, dynamic> body = {
        ...
        "categoryId": valcategory == null
            ? productDetail["categoryId"].toString()
            : categoryList![valcategory!]["id"].toString(),
        "subCategoryId": _selectedIndex == null
            ? productDetail["subCategoryId"].toString()
            : subCategoryList![_selectedIndex]["id"].toString(),
        "categoryName": valcategory == null
            ? productDetail["categoryName"].toString()
            : categoryList![valcategory!]["title"].toString(),
        "subCategoryName": _selectedIndex != null
            ? productDetail["subCategoryName"].toString()
            : subCategoryList![_selectedIndex]["title"].toString(),
                        ...
                        child: ListView(
                          children: [
                            ...
                            productDetail["productStock"] == null
                                ...
                                : TextFormField(
                                    style: TextStyle(color: Color(0xffffffff)),
                                    key: Key(productDetail["productStock"]
                                        .toString()),
                                    initialValue: productDetail["productStock"]
                                        .toString(),
                                    onSaved: (String? value) {
                                      stock = value;
                                    },
