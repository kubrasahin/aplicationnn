...
class CategoryPhotoAdd extends StatefulWidget {
  final String categoryId;
  const CategoryPhotoAdd({super.key, required this.categoryId});

  @override
  State<CategoryPhotoAdd> createState() => _CategoryPhotoAddState();
}

class _CategoryPhotoAddState extends State<CategoryPhotoAdd> {
  ...
  Future imageSave() async {
    ...
    var request = http.MultipartRequest(
      'PUT',
      Uri.parse("http://185.88.175.96:/rest/category-uploadImage/$id"),
    );
